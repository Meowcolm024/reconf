...
use crate::core::{ElaboratedDecl, ElaboratedExpr, ElaboratedModule};
use crate::error::Result;
use crate::eval::Value;
use crate::eval::core::PreparedCoreNormalizer;
use crate::resolve::resolved::{ResolvedImport, ResolvedModule, ResolvedModuleBody};
use crate::typeck::{CoreElaborator, CoreModuleElaborator};
...
impl<'a> ModuleDeclEvaluator<'a> {
    ...
    fn evaluate_typed(&self, expr: crate::core::TypedCoreExpr) -> Result<Value> {
