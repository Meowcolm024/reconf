...
use reconf_core::core::{CoreDecl, CoreImport, CoreModule};
use reconf_core::eval::Value;
use reconf_core::source::{FilesystemSourceProvider, SourceProvider};
use reconf_core::syntax::surface::{Decl, FileAst};
...
impl SessionArtifacts {
    ...
    fn surface_with(
        &self,
        next: &FileAst,
        output: Option<reconf_core::syntax::surface::Expr>,
    ) -> FileAst {
    ...
    fn core_with(
        &self,
        next: &CoreModule,
        output: Option<reconf_core::core::CoreExpr>,
    ) -> CoreModule {
