...
use reconf::core::{CoreDecl, CoreExpr, CoreImport, CoreModule, CoreType, GlobalRef, TypeAliasRef};
use reconf::error::ErrorCode;
use reconf::eval::Value;
use reconf::resolve::names::{NameScope, Namespace};
use reconf::resolve::resolved::{
...
fn resolved_import_selects_requested_exports_from_module_exports() {
    ...
    exports.define_type("Port".to_string(), type_export(0, CoreType::Int));
    let exports = exports.finish();
    let import = reconf::resolve::resolved::ResolvedImport::new(CoreImport {
        path: "lib.reconf".to_string(),
...
fn resolved_module_exposes_resolved_exports() {
    ...
    let module = ResolvedModule::new(PathBuf::from("main.reconf"), body, exports);

    assert_eq!(module.path(), PathBuf::from("main.reconf"));
...
fn resolved_module_builder_finalizes_with_exports() {
    ...
    exports.define_type("Port".to_string(), type_export(0, CoreType::Int));
    let exports = exports.finish();
    let path = PathBuf::from("lib.reconf");
...
fn resolved_program_indexes_resolved_modules_by_path() {
    ...
    let exports = exports.finish();
    let path = PathBuf::from("main.reconf");
...
fn resolved_module_body_preserves_lowered_module_shape() {
    ...
    assert_eq!(body.imports()[0].path(), "lib.reconf");
